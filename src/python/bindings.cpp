...
std::span<const float> as_vector_span(const py::array &array) {
  ...
  return std::span<const float>(static_cast<const float *>(info.ptr),
                                static_cast<size_t>(info.size));
}

std::span<const long long> as_id_span(const py::array &array) {
  auto info = array.request();
  return std::span<const long long>(static_cast<const long long *>(info.ptr),
                                    static_cast<size_t>(info.size));
}
} // namespace
...
PYBIND11_MODULE(_core, m) {
  ...
  py::class_<spheni::IndexSpec>(m, "IndexSpec")
      .def(py::init<int, spheni::Metric, spheni::IndexKind, bool>(),
           py::arg("dim"), py::arg("metric"), py::arg("kind"),
           py::arg("normalize") = true)
      .def(py::init<int, spheni::Metric, spheni::IndexKind, spheni::StorageType,
                    bool>(),
           py::arg("dim"), py::arg("metric"), py::arg("kind"),
           py::arg("storage"), py::arg("normalize") = true)
      .def(py::init<int, spheni::Metric, spheni::IndexKind, int, bool>(),
           py::arg("dim"), py::arg("metric"), py::arg("kind"), py::arg("nlist"),
           py::arg("normalize") = true)
      .def(py::init<int, spheni::Metric, spheni::IndexKind, int,
                    spheni::StorageType, bool>(),
           py::arg("dim"), py::arg("metric"), py::arg("kind"), py::arg("nlist"),
           py::arg("storage"), py::arg("normalize") = true)
  ...
  py::class_<spheni::Engine>(m, "Engine")
          ...
          [](spheni::Engine &self,
            ...
            if (vectors.shape(1) != self.dim()) {
              throw py::value_error(
                  "vectors second dimension must match index dim");
            }
      ...
      .def(
          "search",
          [](const spheni::Engine &self,
             const py::array_t<float, py::array::c_style> &query, int k) {
      ...
      .def(
          "search_batch",
          [](const spheni::Engine &self,
             const py::array_t<float, py::array::c_style> &queries, int k) {
            ...
            if (queries.shape(1) != self.dim()) {
              throw py::value_error(
                  "queries second dimension must match index dim");
            }
