...
In version 0.0.1, spheni is a functional, header-only-friendly C++ vector search library that implements a brute-force "Flat" index.  
It handles the basic lifecycle of vector data: ingestion, normalization, and similarity searching.

> [!NOTE]
> This is the initial historical snapshot. For current architecture, see `docs/arch/v0.1.1.md`.
